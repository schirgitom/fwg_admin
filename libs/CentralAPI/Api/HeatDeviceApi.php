...
class HeatDeviceApi
{
    ...
    public const contentTypes = [
        ...
        'apiHeatDeviceMigrateDeviceEUIGet' => [
            'application/json',
        ],
        'apiHeatDevicePost' => [
            'application/json',
        ...
        'apiHeatDeviceUpdateVisualizationGet' => [
            'application/json',
        ],
    ];
    ...
    /**
     * Operation apiHeatDeviceMigrateDeviceEUIGet
     *
     * @param  string $device_eui device_eui (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiHeatDeviceMigrateDeviceEUIGet'] to see the possible values for this operation
     *
     * @throws \FWGCentralAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return bool
     */
    public function apiHeatDeviceMigrateDeviceEUIGet($device_eui, string $contentType = self::contentTypes['apiHeatDeviceMigrateDeviceEUIGet'][0])
    {
        list($response) = $this->apiHeatDeviceMigrateDeviceEUIGetWithHttpInfo($device_eui, $contentType);
        return $response;
    }

    /**
     * Operation apiHeatDeviceMigrateDeviceEUIGetWithHttpInfo
     *
     * @param  string $device_eui (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiHeatDeviceMigrateDeviceEUIGet'] to see the possible values for this operation
     *
     * @throws \FWGCentralAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function apiHeatDeviceMigrateDeviceEUIGetWithHttpInfo($device_eui, string $contentType = self::contentTypes['apiHeatDeviceMigrateDeviceEUIGet'][0])
    {
        $request = $this->apiHeatDeviceMigrateDeviceEUIGetRequest($device_eui, $contentType);
    ...
    /**
     * Operation apiHeatDeviceMigrateDeviceEUIGetAsync
     *
     * @param  string $device_eui (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiHeatDeviceMigrateDeviceEUIGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiHeatDeviceMigrateDeviceEUIGetAsync($device_eui, string $contentType = self::contentTypes['apiHeatDeviceMigrateDeviceEUIGet'][0])
    {
        return $this->apiHeatDeviceMigrateDeviceEUIGetAsyncWithHttpInfo($device_eui, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiHeatDeviceMigrateDeviceEUIGetAsyncWithHttpInfo
     *
     * @param  string $device_eui (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiHeatDeviceMigrateDeviceEUIGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiHeatDeviceMigrateDeviceEUIGetAsyncWithHttpInfo($device_eui, string $contentType = self::contentTypes['apiHeatDeviceMigrateDeviceEUIGet'][0])
    {
        $returnType = 'bool';
        $request = $this->apiHeatDeviceMigrateDeviceEUIGetRequest($device_eui, $contentType);
    ...
    /**
     * Create request for operation 'apiHeatDeviceMigrateDeviceEUIGet'
     *
     * @param  string $device_eui (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiHeatDeviceMigrateDeviceEUIGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiHeatDeviceMigrateDeviceEUIGetRequest($device_eui, string $contentType = self::contentTypes['apiHeatDeviceMigrateDeviceEUIGet'][0])
    {

        // verify the required parameter 'device_eui' is set
        if ($device_eui === null || (is_array($device_eui) && count($device_eui) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $device_eui when calling apiHeatDeviceMigrateDeviceEUIGet'
            );
        }


        $resourcePath = '/api/HeatDevice/Migrate/{DeviceEUI}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($device_eui !== null) {
            $resourcePath = str_replace(
                '{' . 'DeviceEUI' . '}',
                ObjectSerializer::toPathValue($device_eui),
                $resourcePath
            );
        }
    ...
    /**
     * Operation apiHeatDeviceUpdateVisualizationGet
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiHeatDeviceUpdateVisualizationGet'] to see the possible values for this operation
     *
     * @throws \FWGCentralAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return bool
     */
    public function apiHeatDeviceUpdateVisualizationGet(string $contentType = self::contentTypes['apiHeatDeviceUpdateVisualizationGet'][0])
    {
        list($response) = $this->apiHeatDeviceUpdateVisualizationGetWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation apiHeatDeviceUpdateVisualizationGetWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiHeatDeviceUpdateVisualizationGet'] to see the possible values for this operation
     *
     * @throws \FWGCentralAPI\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of bool, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiHeatDeviceUpdateVisualizationGetWithHttpInfo(string $contentType = self::contentTypes['apiHeatDeviceUpdateVisualizationGet'][0])
    {
        $request = $this->apiHeatDeviceUpdateVisualizationGetRequest($contentType);
    ...
    /**
     * Operation apiHeatDeviceUpdateVisualizationGetAsync
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiHeatDeviceUpdateVisualizationGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiHeatDeviceUpdateVisualizationGetAsync(string $contentType = self::contentTypes['apiHeatDeviceUpdateVisualizationGet'][0])
    {
        return $this->apiHeatDeviceUpdateVisualizationGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiHeatDeviceUpdateVisualizationGetAsyncWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiHeatDeviceUpdateVisualizationGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiHeatDeviceUpdateVisualizationGetAsyncWithHttpInfo(string $contentType = self::contentTypes['apiHeatDeviceUpdateVisualizationGet'][0])
    {
        $returnType = 'bool';
        $request = $this->apiHeatDeviceUpdateVisualizationGetRequest($contentType);
    ...
    /**
     * Create request for operation 'apiHeatDeviceUpdateVisualizationGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiHeatDeviceUpdateVisualizationGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiHeatDeviceUpdateVisualizationGetRequest(string $contentType = self::contentTypes['apiHeatDeviceUpdateVisualizationGet'][0])
    {


        $resourcePath = '/api/HeatDevice/UpdateVisualization';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
