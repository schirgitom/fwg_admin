...
class Customer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('send_to_heidi', $data ?? [], null);
    ...
    */
    ...
    public function setCustomerNumber($customer_number)
    {
        ...
        if ((mb_strlen($customer_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_number when calling Customer., must be bigger than or equal to 1.');
        }
     ...
     * @return bool|null
     */
    public function getSendToHeidi()
    {
        return $this->container['send_to_heidi'];
    }

    /**
     * Sets send_to_heidi
     *
     * @param bool|null $send_to_heidi send_to_heidi
     *
     * @return self
     */
    public function setSendToHeidi($send_to_heidi)
    {
        if (is_null($send_to_heidi)) {
            throw new \InvalidArgumentException('non-nullable send_to_heidi cannot be null');
        }
        $this->container['send_to_heidi'] = $send_to_heidi;
